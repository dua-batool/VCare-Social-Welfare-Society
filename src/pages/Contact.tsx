            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">shermindanish@gmail.com</p>
                    {/* <p className="text-gray-600">support@helpinghands.org</p> */}
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  {/* <a href="https://linkedin.com" className="bg-gray-100 hover:bg-gray-200 p-3 rounded-full transition-colors duration-300">
                    <svg className="w-5 h-5 text-gray-600" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
